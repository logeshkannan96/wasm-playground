...
// node_modules/@ruby/wasm-wasi/dist/esm/console.js
function consolePrinter({ stdout, stderr } = {
  ...
  function getMemoryView() {
    ...
    if (_view === void 0 || _view.buffer.byteLength === 0) {
  ...
  return {
    addToImports(imports) {
      ...
      wasiImport.fd_fdstat_get = (fd, fdstat) => {
        ...
        view.setUint8(fs_filetypePtr, 2);
...
//# sourceMappingURL=@ruby_wasm-wasi.js.map
